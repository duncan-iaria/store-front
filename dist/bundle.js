...
__WEBPACK_IMPORTED_MODULE_1__controller__["a" /* controller */].getAllProducts();

//attatch low product listener
__WEBPACK_IMPORTED_MODULE_1__controller__["a" /* controller */].lowProductsButton();
...
const controller =
{
    ...
    {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()( '#all-products' ).on( 'click', renderAllProducts );
        renderAllProducts();
    },

    lowProductsButton: function()
    {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()( '#low-products' ).on( 'click', getLowProducts );
    }
}
...
function renderAllProducts()
{
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.ajax( requestParams ).done( render );

    function render( tData )
    {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()( '#products' ).empty();

        for( let i = 0; i < tData.length; i++ )
        {
            //clear current table
            __WEBPACK_IMPORTED_MODULE_0_jquery___default()( '#products' ).append
            ( 
...
module.exports = __webpack_require__.p + "0d102b3e5784752cf83740a31a7c7ecb.ttf";
